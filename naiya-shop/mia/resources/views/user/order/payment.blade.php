	...
	<div class="right l">
                <div class="title yahei f20 pink">
                    <ul class="tab-tit clearfix">
                        ...
                        <li class="cur dhref"><a href="{{ url('/user/order/payment') }} " style="color: #fff;">待付款<em>（{{ $paymentNum -> count }}）</em></a></li>
            ...
            <div class="icspblock">
                <table class="msctab outer" width="100%" cellspacing="0" cellpadding="0" border="0">
				   ...
				   <tr class="orderListHead">
					...
					@if($key -> status == 1)
					<span>
						<a href="{{ url('/user/cartOrder/oid') }}/{{ $key -> id }}" data-oc="20160620591306792" class="changeAddressBtn r" style="background:#f450a2; color:#fff; width:50px;"><b>去支付</b></a>
					</span>
                    <span>
						
						<a href="{{ url('/user/updatePayment') }}/{{ $key -> id }}" data-oc="20160620591306792" data-c="0" class="cancelOrder pink r">取消订单</a>
					</span>
					@endif
                        </th>
                    </tr>
