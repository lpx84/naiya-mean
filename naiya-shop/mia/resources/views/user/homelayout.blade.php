...
<html>
    ...
    <head>
        ...
        <title>@yield('title') - {{ config('app.miaName') }}</title>
            ...
            <div class="header-nav">
                <div class="w1100">
                    ...
                    <div class="menus" id="navMenus">
                        <div class="tit">
                            <h3 ><b style="line-heith:2px;">全部商品分类</b></h3>
  ...
  <ul>
    ...
    <li>
        <a href="{{ url('/user/return/list') }}">退货退款</a>
    </li>
  </ul>
  <div class="title">我的收藏</div>
  <ul>
    <li>
        <a href="{{ url('/user/mybrand') }}">我收藏的品牌</a>
    </li>
	<li><a href="{{ url('/user/mygoods') }}">我收藏的商品</a></li>
  </ul>
  <div class="title">我的分享</div>
  <ul>
    <!--<li>
        <a href="http://local.naiya.cc/home/invite/lists">我邀请的朋友</a></li>-->
    <li>
    <a href="{{ url('/user/comment') }}">商品口碑</a></li>
  </ul>
  <div class="title">我的优惠</div>
  <ul>
    <li>
        <a href="{{ url('/user/score') }}">积分管理</a>
    </li>
    <!--<li>
        <a href="http://local.naiya.cc/my_coupon">代金券管理</a>
    </li>
    <li>
        <a href="http://local.naiya.cc/my_getredbag">红包管理</a>
    </li>
    <li style="text-indent:12px;">
        <a href="http://local.naiya.cc/my_getredbag">我的红包</a>
    </li>
    <li style="text-indent:12px;">
        <a href="http://local.naiya.cc/my_shareredbag">分享红包</a>
    </li>-->
  </ul>
  <div class="title">我的账户</div>
  <ul>
    <li>
        <a href="{{ url('/user/prefile') }}">账户信息</a>
    </li>
    <!--<li>
        <a href="http://local.naiya.cc/home/balance/index">账户余额</a>
    </li>
    <li>
        <a href="http://local.naiya.cc/home/account/idStatus">实名认证</a>
    </li>-->
    <li>
        <a href="{{ url('/user/prefile/password') }}">修改密码</a>
    </li>
    <li>
        <a href="{{ url('user/prefile/ress') }}">地址管理</a>
    </li>
    <li>
        <a href="{{ url('user/prefile/messages') }}">奶牙消息</a>
    </li>  
  </ul>
</div>
            @yield('content')
