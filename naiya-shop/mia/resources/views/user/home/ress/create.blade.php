	...
	<div class="right l">
                <div class="title yahei f20 pink">地址管理</div>
					...
					@if(session('info'))
                        ...
                        <div class="icspblock">
						<form method="post" action="{{asset('/user/prefile/ress')}}">
							{{csrf_field()}}
                          ...
                          <table class="msctab tab09" style="border:0px;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <td width="89%">
                                    ...
                                    <input id="name" class="inp w120" onblur="check_shipping('name')" name="name" value="{{ old('name') }}" type="text">
								...
								<div data-toggle="distpicker">
									<div class="row">
										<div class="form-group col-md-3">
										  ...
										  <select class="form-control" id="province1" name="province" style="height:23px;"></select>
										</div>
										<div class="form-group  col-md-3">
                                ...
                                <td width="89%"> 
                                    <input id="detail" class="inp w120" name="detail" onblur="check_shipping('name')" value="{{ old('detail') }}" type="text" style="width:50%">
                                    <span id="new_name_error"></span>
                                </td>
                                </tr>
                                <tr>
                                ...
                                <td>
                                    <input id="ship_mobile" name="phone" class="inp w188" onblur="check_shipping('mobile')" value="{{ old('phone') }}" type="text">
                                ...
                                <td>
                                    <input type="submit" id="saveAddressHome" class="home_button" value="添加">
