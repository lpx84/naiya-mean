        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    @endif
                    <!-- form start -->
                    <form role="form" action="{{asset('/merchant/article')}}/{{$data->id}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="oldImg">原封面图</label>
                                <input type="hidden" id="oldImg" name="oldImg" value="{{$data -> img}}">
                                <img src="{{asset('/uploads')}}/{{$data -> img}}" />
                            </div>
                            <div class="form-group">
                                <label for="img">封面图</label>
                                <input type="file" id="img" name="img">
                                <p class="help-block">请选择一张封面图</p>
                            </div>
                            <div class="form-group">
