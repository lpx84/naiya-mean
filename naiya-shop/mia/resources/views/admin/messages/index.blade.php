...
<div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                站内信管理
                <small>在这里进行站内信管理</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">站内信列表</a></li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="{{url('/admin/messages')}}" method="get">
                            <div class="row">
                                <div class="col-xs-2">
                                    <!-- select -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>{{$v -> id}}</td>
                                    <td>{{$v -> title}}</td>
                                    <td><a href="{{url('/admin/messages')}}/{{$v -> id}}">详细内容请点击此处查看</a></td>
                                    <td>{{date('Y-m-d H:i:s',$v -> create_at)}}</td>
                                    <td>
                                    <a class="btn btn-primary btn-xs" href="{{url('/admin/messages')}}/{{$v->id}}/edit">编辑</a>
