                        ...
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>{{$v -> id}}</td>
                                    <td>{{$v -> username}}</td>
                                    <td align="center"><img src="{{url(config('app.userUrl'))}}/{{$v -> header}}" width="30" height="30"/></td>
                                    <td>{{$v -> status == 1 ? '已激活' : '已禁用'}}</td>
                                    <td>{{$v -> account}}</td>
                                    <td>{{$v -> email}}</td>
                                    <td>{{$v -> phone}}</td>
									<td>{{$v -> is_real_check == 1 ? '已认证' : '未认证'}}</td>
									<td><a class="btn btn-default btn-sm" href="{{url('/admin/user')}}/{{$v->id}}">查看详情</a></td>
                                    <td>
                                    <a class="btn btn-primary btn-xs" href="{{url('/admin/user')}}/{{$v->id}}/edit">编辑</a>
