...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            帮助中心内容管理
            <small>帮助中心内容添加</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">帮助中心内容添加</a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">帮助中心内容添加</h3>
                    </div><!-- /.box-img -->
                    @if (count($errors) > 0)
                    ...
                    @endif
                    <!-- form start -->
                    <form role="form" action="{{asset('/admin/help')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="box-body">
