...
<div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                帮助分类管理
                <small>在这里进行帮助的分类管理</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">帮助分类列表</a></li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">帮助分类列表</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
							<form action="{{url('/admin/helpcate')}}" method="get">
                            <div class="row">
                                <div class="col-xs-2">
                                    <!-- select -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-primary btn-xs" href="{{url('/admin/helpcate')}}/{{$v->id}}/edit">编辑</a>
