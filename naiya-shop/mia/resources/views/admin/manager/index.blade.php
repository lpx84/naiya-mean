                        ...
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>{{$v -> id}}</td>
                                    <td>{{$v -> username}}</td>
                                    <td><img src="{{url(config('app.managerUrl'))}}/{{$v -> header}}" width="30" height="30"/></td>
                                    <td>{{$v -> status == 1 ? '已激活' : '已禁用'}}</td>
                                    <td>{{date('Y-m-d',$v -> create_at)}}</td>
                                    <td>
                                    <a class="btn btn-primary btn-xs" href="{{url('/admin/manager')}}/{{$v->id}}/edit">编辑</a>
